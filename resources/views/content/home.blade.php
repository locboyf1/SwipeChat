...
<head>
    <meta charset="utf-8">
    <title>Swipe - Chat với cả thế giới</title>
                ...
                <div class="container">
                    <div class="inside">
                        <div class="nav nav-tab menu">
                            <button class="btn"><img class="avatar-xl" src="{{ auth()->user()->avatar_path }}"
                                    alt="avatar"></button>
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn power"><i
                                    ...
                                    <div class="list-group" id="contacts" role="tablist">
                                        ...
                                        <a href="#" class="filterMembers all online contact"
                                            ...
                                            <img class="avatar-md" src="dist/img/avatars/avatar-female-3.jpg"
                                                data-toggle="tooltip" data-placement="top" title="Harmony"
                                                alt="avatar">
                                            <div class="status">
                                                <i class="material-icons online">fiber_manual_record</i>
                                            </div>
                                        ...
                                        <a href="#" class="filterMembers all offline contact"
                                            data-toggle="list">
                                        ...
                                        <a href="#" class="filterMembers all offline contact"
                                            ...
                                            <img class="avatar-md" src="dist/img/avatars/avatar-male-3.jpg"
                                                data-toggle="tooltip" data-placement="top" title="Ryan"
                                                alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                        ...
                                        <a href="#" class="filterMembers all offline contact"
                                            ...
                                            <img class="avatar-md" src="dist/img/avatars/avatar-male-4.jpg"
                                                data-toggle="tooltip" data-placement="top" title="Mildred"
                                                alt="avatar">
                                            <div class="status">
                                                <i class="material-icons offline">fiber_manual_record</i>
                                            </div>
                                                        ...
                                                        <div class="parent">
                                                            <div class="field">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="Michael" required>
                                                            </div>
                                                            <div class="field">
                                                                <label for="lastName">Last name <span>*</span></label>
                                                                <input type="text" class="form-control"
                                                                    id="lastName" placeholder="Last name"
                                                                    value="Knudsen" required>
                                                            </div>
                                                        </div>
                                                        <div class="field">
                                                    ...
                                                    <div class="history">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label"
                                                                for="same-address">Hide will remove your chat history
                                        ...
                                        <div class="inside">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn disabled" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false" disabled><i
                                                        class="material-icons md-30">more_vert</i></button>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <button class="dropdown-item"><i
                                                            class="material-icons">phone_in_talk</i>Voice
